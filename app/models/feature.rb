class Feature < DashboardRecord
  ...
  has_one :closed_feature, primary_key: :dashboard_compound_key, foreign_key: :dashboard_compound_key
  has_many :diary_notes, -> { displayable.order(updated_at: :desc) },
           primary_key: :dashboard_compound_key, foreign_key: :dashboard_compound_key
  has_one :last_diary_note, -> { displayable.order(updated_at: :desc).limit(1) },
          primary_key: :dashboard_compound_key, foreign_key: :dashboard_compound_key, class_name: 'DiaryNote'
  has_one :feature_date, primary_key: :dashboard_compound_key, foreign_key: :dashboard_compound_key
